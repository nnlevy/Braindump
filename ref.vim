...
c$       => erase until the end of the line, insert mode
p        => put
r        => replace under character
/        => search (n next, N previous)
G        => move to end of the file (#G moves to line number)
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  3. Move the cursor the c) line, ABOVE where the deleted line should go.
...
---> This line has a few words that need changing usf the change operator.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  pi:. Look what files exist in the directory:  :!ls   or  :!dir
